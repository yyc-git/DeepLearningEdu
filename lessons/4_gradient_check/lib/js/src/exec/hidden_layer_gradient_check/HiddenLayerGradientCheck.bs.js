...
function testCheckHiddenLayerGradient(param) {
  Vector$Gender_analyze.create([
        -2,
        -1,
        1
      ]);
  Vector$Gender_analyze.map(Vector$Gender_analyze.create([/* Female */1]), _convertLabelToFloat);
  return 1;
}

console.log("begin test");

testCheckHiddenLayerGradient(undefined);
...
exports.testCheckHiddenLayerGradient = testCheckHiddenLayerGradient;
/*  Not a pure module */
